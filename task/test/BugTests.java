...
public class BugTests extends StageTest {
  ...
  //Each type
  @DynamicTest(data = "dataForTesting", order = 24)
  ...
  @DynamicTest(data = "dataForTesting", files = "getFiles", order = 25)
  ...
  @DynamicTest(data = "dataForTesting", order = 26)
  ...
  @DynamicTest(data = "dataForTesting", order = 27)
  ...
  //Booleans
  @DynamicTest(data = "dataForBooleans", order = 28)
  ...
  @DynamicTest(data = "dataForBooleans", order = 29)
  ...
  //Words
  @DynamicTest(data = "dataForWords", order = 30)
  ...
  //Numbers
  @DynamicTest(data = "dataForNumbers", order = 31)
  ...
  @DynamicTest(data = "dataForOverUnderflow", order = 32)
  ...
  Object[][] dataForPowDivide() {
    return new Object[][]{
            {new Integer[]{9, 19}, "/pow 0 1", "1350851717672992089"},
  ...
  @DynamicTest(data = "dataForPowDivide", order = 33)
